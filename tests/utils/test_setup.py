...
class TestSetup():
    ...
    case_000 = case_000.subjects.extend([child1, mother1, alledged_father1])
    case_200 = case_200.subjects.extend([child1, mother2, alledged_father2])
    case_400 = case_400.subjects.extend([child1, mother3, alledged_father3])
    case_020 = case_020.subjects.extend([child1, mother4, alledged_father1])
    case_040 = case_040.subjects.extend([child1, mother5, alledged_father1])
    case_002 = case_002.subjects.extend([child1, mother2, alledged_father4])
    case_004 = case_004.subjects.extend([child1, mother3, alledged_father5])
    case_111 = case_111.subjects.extend([child1, mother6, alledged_father6])

    # case_000 = LabCase(case_name).subjects.extend([child1, mother1, alledged_father1])
    # case_200 = LabCase(case_name).subjects.extend([child1, mother2, alledged_father2])
    # case_400 = LabCase(case_name).subjects.extend([child1, mother3, alledged_father3])
    # case_020 = LabCase(case_name).subjects.extend([child1, mother4, alledged_father1])
    # case_040 = LabCase(case_name).subjects.extend([child1, mother5, alledged_father1])
    # case_002 = LabCase(case_name).subjects.extend([child1, mother2, alledged_father4])
    # case_004 = LabCase(case_name).subjects.extend([child1, mother3, alledged_father5])
    # case_111 = LabCase(case_name).subjects.extend([child1, mother6, alledged_father6])
